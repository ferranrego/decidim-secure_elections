      ...
      module Admin
        describe CreateElection do
          ...
          it "creates a draft election from a title alone" do
            expect { command.call }.to change(Decidim::Elections::Vocdoni::Election, :count).by(1)

            election = Decidim::Elections::Vocdoni::Election.last
          ...
          it "writes nothing to the blockchain" do
            ...
            expect(Decidim::Elections::Vocdoni::Election.last.vocdoni_process_id).to be_nil
          end
          ...
          context "when the title is blank" do
            ...
            it "leaves no draft behind" do
              ...
              expect(Decidim::Elections::Vocdoni::Election.count).to be_zero
            end
          end
        end
      end
