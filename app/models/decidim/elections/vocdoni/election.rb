...
module Decidim
  module Elections
    module Vocdoni
      ...
      #   Decidim::Elections::Vocdoni::PublishElectionJob and **irreversible**: once set, the
      #   election can no longer be edited.
      class Election < Vocdoni::ApplicationRecord
        ...
        AUTH_FIELDS = Vocdoni::CensusMember::CREDENTIAL_FIELDS
        ...
        TWO_FA_FIELDS = Vocdoni::CensusMember::TWO_FA_FIELDS
        ...
        has_many :census_members,
                 foreign_key: "decidim_vocdoni_election_id",
                 class_name: "Decidim::Elections::Vocdoni::CensusMember",
                 inverse_of: :election,
                 dependent: :destroy
        ...
        def presenter
          Decidim::Elections::Vocdoni::ElectionPresenter.new(self)
        end

        def self.log_presenter_class_for(_log)
          Decidim::Elections::Vocdoni::AdminLog::ElectionPresenter
        end
        ...
        def display_state
          Decidim::Elections::Vocdoni::ElectionStatusCell.state_for(self)
        end
        ...
        def security_level
          ...
          auth_fields.size >= Vocdoni::CensusMember::MAX_CREDENTIALS ? "mid" : "weak"
        end
        ...
        def incomplete_census_members
          required = Vocdoni::CensusMember.attributes_for(required_member_fields)
          alternatives = Vocdoni::CensusMember.attributes_for(alternative_member_fields)
          return census_members.none if required.none? && alternatives.none?

          table = Vocdoni::CensusMember.arel_table
        ...
        # `decidim.elections.vocdoni.admin.nav.reasons`, so the navigation, the controller
