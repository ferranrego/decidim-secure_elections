...
module Decidim
  module Elections
    module Vocdoni
      ...
      class CensusMember < Vocdoni::ApplicationRecord
        ...
        # these; see {Decidim::Elections::Vocdoni::Election::TWO_FA_METHODS}.
        ...
        belongs_to :election,
                   ...
                   class_name: "Decidim::Elections::Vocdoni::Election",
        ...
        def self.field_label(field)
          I18n.t(field, scope: "decidim.elections.vocdoni.admin.census.member_fields", default: field.to_s)
        end
        ...
        def display_name
          full_name.presence || email.presence || phone.presence || member_number.presence ||
            national_id.presence || I18n.t("decidim.elections.vocdoni.admin.census.members.unnamed")
        end
