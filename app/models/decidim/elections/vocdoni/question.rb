...
module Decidim
  module Elections
    module Vocdoni
      ...
      # (ARCHITECTURE §1).
      class Question < Vocdoni::ApplicationRecord
        ...
        has_many :answers,
                 ...
                 class_name: "Decidim::Elections::Vocdoni::Answer",
                 inverse_of: :question,
                 dependent: :destroy
        ...
        def presenter
          Decidim::Elections::Vocdoni::QuestionPresenter.new(self)
        end

        def self.log_presenter_class_for(_log)
          Decidim::Elections::Vocdoni::AdminLog::QuestionPresenter
        end
