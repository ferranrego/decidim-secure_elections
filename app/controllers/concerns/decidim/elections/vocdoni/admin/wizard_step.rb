  ...
  module Elections
    module Vocdoni
      module Admin
        ...
        # the navigation and `Decidim::Elections::Vocdoni::Admin::Permissions` cannot drift
        # apart.
        #
        ...
        # `app/permissions/decidim/elections/vocdoni/admin/permissions.rb`. The permission
        ...
        module WizardStep
          ...
          included do
            helper_method :vocdoni_step_path, :current_wizard_step
          end
          ...
          def ensure_step_reachable!
            ...
            redirect_to vocdoni_step_path(current, current.furthest_reachable_step)
          end
          ...
          #
          # @return [Decidim::Elections::Vocdoni::Election, nil]
          def wizard_election
          ...
          def wizard_blocker_message(blocker)
            ...
            I18n.t(blocker, scope: "decidim.elections.vocdoni.admin.nav.reasons")
          end
          ...
          # @return [String]
          def vocdoni_step_path(election, step)
            case step.to_sym
