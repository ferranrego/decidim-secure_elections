  ...
  module Elections
    module Vocdoni
      ...
      module NeedsElection
        ...
        included do
          include Decidim::Elections::Vocdoni::VotingPageLink
        ...
        def elections
          @elections ||= Decidim::Elections::Vocdoni::Election
        ...
        def election_state(target = election)
          Decidim::Elections::Vocdoni::ElectionStatusCell.state_for(target)
        end
