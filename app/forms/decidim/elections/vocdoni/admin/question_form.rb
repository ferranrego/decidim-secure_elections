    ...
    module Vocdoni
      module Admin
        ...
        class QuestionForm < Decidim::Form
          ...
          validates :question_type, inclusion: { in: Decidim::Elections::Vocdoni::Question::QUESTION_TYPES }
          ...
          def flag_duplicate(answer)
            answer.errors.add(
              ...
              I18n.t("decidim.elections.vocdoni.admin.elections.editor.duplicate_option")
            )
          end
