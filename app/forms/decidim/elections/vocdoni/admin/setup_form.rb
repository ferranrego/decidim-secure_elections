      ...
      module Admin
        ...
        class SetupForm < Decidim::Form
          ...
          def election_is_off_chain
            ...
            errors.add(:base, I18n.t("decidim.elections.vocdoni.admin.setup.errors.already_on_chain"))
          end

          def details_are_complete
            return if election&.details_complete?

            errors.add(:base, I18n.t("decidim.elections.vocdoni.admin.setup.errors.details_incomplete"))
          end

          def questions_are_complete
            return if election&.questions_complete?

            errors.add(:base, I18n.t("decidim.elections.vocdoni.admin.setup.errors.questions_incomplete"))
          end
          ...
          def census_is_configured
            ...
            errors.add(:base, I18n.t("decidim.elections.vocdoni.admin.setup.errors.census_incomplete"))
          end

          def calendar_is_complete
            return if election&.calendar_complete?

            errors.add(:base, I18n.t("decidim.elections.vocdoni.admin.setup.errors.calendar_incomplete"))
          end

          def module_is_configured
            return if Decidim::Elections::Vocdoni.configured?

            errors.add(:base, I18n.t("decidim.elections.vocdoni.admin.setup.errors.not_configured"))
          end
        end
      end
    end
