    ...
    module Vocdoni
      module Admin
        ...
        class CensusForm < Decidim::Form
          ...
          validates :two_factor_method, inclusion: { in: ->(_form) { Vocdoni::Election::TWO_FA_METHODS.keys } }
          ...
          def two_fa_fields
            Vocdoni::Election::TWO_FA_METHODS.fetch(two_factor_method.to_s, [])
          end
          ...
          def available_credentials
            Vocdoni::CensusMember::CREDENTIAL_FIELDS
          end

          def available_two_factor_methods
            Vocdoni::Election::TWO_FA_METHODS.keys
          end

          def max_credentials
            Vocdoni::CensusMember::MAX_CREDENTIALS
          end
