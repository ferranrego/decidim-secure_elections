...
require "decidim/elections/vocdoni/admin"
require "decidim/elections/vocdoni/api"
require "decidim/elections/vocdoni/engine"
require "decidim/elections/vocdoni/admin_engine"
require "decidim/elections/vocdoni/component"

# Phase-4 spike (see lib/decidim/elections/vocdoni/phase_4_spike.rb): loaded
...
require "decidim/elections/vocdoni/phase_4_spike" if ENV["PHASE_4_SPIKE"] == "1"
...
module Decidim
  ...
  # Decidim. See `app/packs/src/decidim/elections/vocdoni/voter/`.
  #
  ...
  module Elections
    module Vocdoni
      ...
      # name and would otherwise expect `decidim_elections_vocdoni_*`. It only does
      ...
      # `Decidim::Elections::Vocdoni.configure { |c| c.api_url = … }` block in an initializer.
      class << self
      ...
      def self.validate_configuration!
        ...
        raise Decidim::Elections::Vocdoni::ConfigurationError,
              "decidim-elections-vocdoni is not configured. Missing: #{missing.join(", ")}"
      end
