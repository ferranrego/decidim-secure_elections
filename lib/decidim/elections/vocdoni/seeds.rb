    ...
    module Vocdoni
      ...
      class Seeds < Decidim::Seeds
        ...
        def call
          ...
          # `Decidim::Elections::Vocdoni::Election` (this repo's schema) that
        ...
        def create_election!(component:, published:)
          ...
          Decidim.traceability.perform_action!(
            ...
            Decidim::Elections::Vocdoni::Election.create!(params)
          end
        end
        ...
        def create_question!(election:, position:, question_type:, answers_count:)
          ...
          question = Decidim::Elections::Vocdoni::Question.create!(
            election:,
            position:,
            question_type:,
          ...
          answers_count.times do |value|
            Decidim::Elections::Vocdoni::Answer.create!(
              question:,
