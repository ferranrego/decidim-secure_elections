...
module Decidim
  module Elections
    module Vocdoni
      ...
      # met renders as a disabled span (see the `admin_vocdoni_menu`
      ...
      class AdminEngine < ::Rails::Engine
        isolate_namespace Decidim::Elections::Vocdoni::Admin
        ...
        initializer "decidim_elections_vocdoni_admin.menu" do
          Decidim.menu :admin_vocdoni_menu do |menu|
            ...
            menu.add_item :vocdoni_main,
                          I18n.t("main", scope: "decidim.elections.vocdoni.admin.menu"),
                          @election.nil? ? new_election_path : proxy&.edit_election_path(@election),
                          active: @election.nil? && is_active_link?(new_election_path),
                          icon_name: "bill-line"

            menu.add_item :vocdoni_questions,
                          I18n.t("questions", scope: "decidim.elections.vocdoni.admin.menu"),
            ...
            menu.add_item :vocdoni_census,
                          I18n.t("census", scope: "decidim.elections.vocdoni.admin.menu"),
